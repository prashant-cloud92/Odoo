...
class ShutterType(models.Model):
    ...
    lock_product_id = fields.Many2one(comodel_name='product.product',string='Lock Product')
    stopper_product_id = fields.Many2one(comodel_name='product.product',string='Stopper Product')
    blade_product_id=fields.Many2one(comodel_name='product.product',string='Blade Product')
